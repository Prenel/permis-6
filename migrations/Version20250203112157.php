 ...
 */
final class Version20250203112157 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD sub_category_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B6F7494EF7BFE87C');
        $this->addSql('ALTER TABLE question DROP sub_category_id');
